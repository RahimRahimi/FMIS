...
const GridJsAdvanced = (function () {
    ...
    const _componentGridJsAdvanced = function () {
        ...
        // Nested header
        const gridjsNestedHeaderElement = document.querySelector(
            ".gridjs-example-nested-header"
        );
        if (gridjsNestedHeaderElement) {
            const gridjsNestedHeader = new gridjs.Grid({
                className: {
                    table: "table table-bordered datatable-basic",
                },
                sort: true,
                columns: [
                    {
        ...
        // Multi column sort
        const gridjsMultiSortingElement = document.querySelector(
            ".gridjs-example-sort-multi"
        );
        ...
        // Custom sort
        const gridjsCustomSortingElement = document.querySelector(
            ".gridjs-example-sort-custom"
        );
        ...
        // Events
        const gridjsEventsElement = document.querySelector(
            ".gridjs-example-events"
        );
        if (gridjsEventsElement) {
            ...
            gridjsEvents.on("rowClick", (...args) =>
                console.log("row: " + JSON.stringify(args), args)
            );
            gridjsEvents.on("cellClick", (...args) =>
