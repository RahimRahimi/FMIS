...
<head>
	...
	<!-- Icons -->
	<link rel="stylesheet" href="{{asset('icons/fontawesome/styles.min.css')}}" type="text/css">
	<link rel="stylesheet" href="{{asset('icons/icomoon/styles.min.css')}}" type="text/css">
	<link rel="stylesheet" href="{{asset('icons/material/styles.min.css')}}" type="text/css">
	<link rel="stylesheet" href="{{asset('icons/phosphor/styles.min.css')}}" type="text/css">
	@stack('css')
	<!-- Scripts -->
