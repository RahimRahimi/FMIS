    ...
    <div class="container-fluid">
        ...
        <div class="navbar-brand flex-1 flex-lg-0">
            <a href="index.html" class="d-inline-flex align-items-center">
                <img src="{{asset('images/logo_icon.svg')}}" alt="">
                <img src="{{asset('images/logo_text_light.svg')}}" class="d-none d-sm-inline-block h-16px ms-3" alt="">
            </a>
        </div>
        ...
        <ul class="nav flex-row justify-content-end order-1 order-lg-2">
            ...
            <li class="nav-item ms-lg-2">
                <a class="navbar-nav-link navbar-nav-link-icon rounded" href="{{ route('login') }}">
            ...
            <li class="nav-item nav-item-dropdown-lg dropdown ms-lg-2">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="{{ route('logout') }}" class="dropdown-item" aria-labelledby="navbarDropdown" onclick="event.preventDefault();
                        document.getElementById('logout-form').submit();">
