...
@endpush
@section('title')
<title>Edit Budget Income</title>
@endsection
<!-- Content area -->
<div class="content d-flex justify-content-center align-items-center">
    <!-- Registration form -->
    <form action="{{route('incomes.update',2)}}" method="POST" class="flex-fill">
        @csrf
        @method('PUT')
        <div class="row">
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        <div class="text-center mb-3">
                            ...
                            <h5 class="mb-0">Edit Budget Income</h5>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <div class="form-control-feedback form-control-feedback-start">
                                        <select type="text" name="code" class="form-control" required disabled>
                                            <option value="1">S223</option>
                                            <option value="2">M343</option>
                                            <option value="3" selected>H756</option>
                                        </select>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <div class="form-control-feedback form-control-feedback-start">
                                        <input type="text" name="type" class="form-control" readonly value="Operative">
                                        <div class="form-control-feedback-icon">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <div class="form-control-feedback form-control-feedback-start">
                                        <input type="number" name="amount" class="form-control" readonly value="12000">
                                        <div class="form-control-feedback-icon">
                                            <i class="ph-hash text-muted"></i>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <div class="form-control-feedback form-control-feedback-start">
                                        <select type="text" name="recipient" class="form-control">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <div class="form-control-feedback form-control-feedback-start">
                                        <textarea class="form-control" name="description" placeholder="Budget description goes here.."
                                            rows="1"> Lorem ipsum dolor, sit amet consectetur adipisicing elit.</textarea>
                                        <div class="form-control-feedback-icon">
