...
@endpush
@section('title')
<title>Edit Deputy</title>
@endsection
<div class="content d-flex justify-content-center align-items-center">
    <form action="{{route('deputies.update',['deputy' => $deputy->id])}}" method="POST" class="flex-fill">
        @method('PUT')
        @csrf
        <div class="row">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="form-control-feedback form-control-feedback-start">
                                        <input type="text" name="name" class="form-control" placeholder="Supportive..."
                                            autofocus value="{{old('name', $deputy->name)}}">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="description" id="" cols="30" rows="2" class="form-control"
                                        placeholder="Description goes here....">{{$deputy->description}}</textarea>
                                    @error('description')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
